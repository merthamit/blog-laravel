...
<body>
    ...
    @php
        // Asseti burada tanımladık aşağıda kullanmak için.
        $asset = asset('front/') . '/assets/img/home-bg.jpg';
    @endphp
    <!-- Page Header-->
    <header class="masthead" style="background-image: url(@yield('bg', $asset))">
